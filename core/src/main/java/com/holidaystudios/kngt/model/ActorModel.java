...
public class ActorModel {
    ...
    public boolean dirtyFlag = true; // this is a flag that indicates the server state of this actor change - i.e the actor needs to be republished to the clients observing it.
